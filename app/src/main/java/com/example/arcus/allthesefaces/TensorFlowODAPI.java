...
public class TensorFlowODAPI extends MainActivity implements Classifier {
    ...
    public static Classifier create(final int inputSize) throws IOException {
        final TensorFlowODAPI d = new TensorFlowODAPI();
        final String model_file = "file:///android_asset/graph.pb";
        final String label_file = "file:///android_asset/labels.txt";
